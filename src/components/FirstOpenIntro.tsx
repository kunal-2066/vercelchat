        ...
        `}>
          ...
          {step === 1 && (
            <div>
              ...
              <p className="text-slate-300 text-base leading-relaxed mb-4">
                There are no right answers, and nothing here reacts or judges you in the moment.
              </p>
          ...
          {step === 3 && (
            <div>
              <div className="mb-8">
                ...
                <div className="space-y-3">
                  <p className="text-slate-300 text-base leading-relaxed">
                    Mindpex is here for you.
                  </p>
                  <p className="text-slate-300 text-base leading-relaxed">
                    If work ever feels heavier, confusing, or just a bit off, you don’t have to carry it quietly or wait for it to turn into something bigger.
                  </p>
                  <p className="text-slate-300 text-base leading-relaxed">
